...
import { Book, Folder, HelpCircle, ChevronDown, ChevronRight, File, LayoutDashboard } from "lucide-react";
...
interface MenuItem {
  ...
  type: 'category' | 'menu' | 'page' | 'dashboard';
  children?: MenuItem[];
  slug?: string;
...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-hack-background border-r border-gray-800 overflow-y-auto">
      <div className="py-4">
        <h1 className="text-white font-mono text-xl px-4 mb-4">HackNotes</h1>
        {menuItems.map((item) => (
